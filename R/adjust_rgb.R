...
#' @param Ramount Amount to adjust the red component by ([0,1], default:
#'        \code{0})
#' @param Gamount Amount to adjust the green component by ([0,1], default:
#'        \code{0})
#' @param Bamount Amount to adjust the blue component by ([0,1], default:
#'        \code{0})
